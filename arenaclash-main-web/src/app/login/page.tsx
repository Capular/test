...
export default function LoginPage() {
    ...
    if (loading) return null; // Or a full-screen loader, but RootLayout has generic loading
        ...
        <div className="min-h-screen w-full bg-background flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div ref={containerRef} className="w-full max-w-md relative z-10">
                <div className="text-center mb-8">
                    <h1 className="text-4xl font-bold font-rajdhani text-white mb-2 tracking-wide">ANU PAID SCRIM</h1>
                    <p className="text-muted-foreground">The Ultimate Esports Platform</p>
                </div>
