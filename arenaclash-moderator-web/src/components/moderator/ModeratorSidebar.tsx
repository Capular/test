...
import { LogOut, PlayCircle, CheckCircle2, Clock, ChevronDown, User, IndianRupee, ExternalLink } from "lucide-react";
...
export default function ModeratorSidebar() {
    ...
    const menuItems = [
        { id: "matches", label: "Ready Matches", icon: Clock, path: "/moderator/matches" },
        { id: "completed", label: "Completed", icon: CheckCircle2, path: "/moderator/completed" },
        { id: "payouts", label: "Payouts", icon: IndianRupee, path: "/moderator/payouts" },
    ];
            ...
            <div className="flex flex-col flex-1 min-h-0">
                ...
                <div ref={logoRef} className="h-16 flex-shrink-0 flex items-center gap-3 px-5">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-muted-foreground -mt-0.5">Match Hosting</p>
                    </div>
                </div>
                ...
                <div ref={profileRef}>
                    ...
                    >
                        <Avatar className="h-9 w-9 ring-2 ring-background shadow-md">
                            <AvatarImage src={user?.photoURL || undefined} alt={user?.displayName || "Moderator"} className="object-cover" />
